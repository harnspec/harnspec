...
Detailed documentation for each workflow in the HarnSpec repository.
...
- `harnspec-cli` (harnspec binary)
- `harnspec-mcp` (MCP server binary)
- `harnspec-http` (HTTP server binary)
...
- `@harnspec/cli-darwin-x64`
- `@harnspec/cli-linux-x64`
- `@harnspec/cli-windows-x64`
- `@harnspec/mcp-darwin-arm64`
- `@harnspec/mcp-darwin-x64`
- `@harnspec/mcp-linux-x64`
- `@harnspec/mcp-windows-x64`
- `@harnspec/http-darwin-arm64`
- `@harnspec/http-darwin-x64`
- `@harnspec/http-linux-x64`
- `@harnspec/http-windows-x64`
...
- `@harnspec/mcp` (MCP server main package)
- `@harnspec/ui` (UI bundle)
...
**Outputs**: `harnspec-desktop-{os}` artifacts containing Tauri bundles
