...
Common issues and their solutions for HarnSpec GitHub Actions workflows.
...
pnpm --filter @harnspec/core test
```
...
pnpm --filter @harnspec/desktop bundle:linux  # or macos/windows
