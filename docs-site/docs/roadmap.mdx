...
HarnSpec is open source! Check out our [GitHub repository](https://github.com/codervisor/lean-spec) and see the [contributing guide](https://github.com/codervisor/lean-spec/blob/main/CONTRIBUTING.md).
