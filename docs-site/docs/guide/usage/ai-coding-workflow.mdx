...
**See also:** [MCP Integration Guide](/docs/guide/usage/advanced-features/agent-configuration)
...
- **[MCP Integration](/docs/guide/usage/advanced-features/agent-configuration)** - Set up AI access
