...
**另见**：[CLI 参考：create](/zh-Hans/docs/reference/cli#harnspec-create) 获取所有选项
...
**另见**：[CLI 参考：update](/zh-Hans/docs/reference/cli#harnspec-update)
...
**另见**：[CLI 参考：view](/zh-Hans/docs/reference/cli#harnspec-view)
