...
`AGENTS.md` serves as permanent instructions for AI coding agents in your repository. When you run `lean-spec init`, this file is created with HarnSpec guidance.
...
- .github/skills/HarnSpec-sdd/SKILL.md (installed via `lean-spec skill install`)
