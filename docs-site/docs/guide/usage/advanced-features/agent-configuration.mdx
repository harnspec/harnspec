...
**核心提示：** 配置 HarnSpec Agent Skills 以获得完整的功能指导。参见 [Agent Skills 安装](https://github.com/harnspec/harnspec/blob/main/.agents/skills/harnspec/SKILL.md)。
...
- [Agent Skills](https://github.com/harnspec/harnspec/blob/main/.agents/skills/harnspec/SKILL.md) - 方法论指导
