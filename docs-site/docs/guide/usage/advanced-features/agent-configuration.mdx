...
**使用 MCP（推荐）：** 配置 HarnSpec MCP 服务器以获得完整功能。参见 [MCP 集成](/docs/guide/usage/advanced-features/agent-configuration)。
...
参见 [MCP 集成](/docs/guide/usage/advanced-features/agent-configuration) 了解完整设置说明。
...
- [MCP 集成](/docs/guide/usage/advanced-features/agent-configuration) - 模型上下文协议设置
- [编写 AI 可执行的 Spec](/docs/advanced/ai-assisted-spec-writing) - 实用模式
- [入门](/docs/guide/getting-started) - 初始设置指南

---

**相关**：[CLI 参考](/docs/reference/cli) 了解完整的命令文档
