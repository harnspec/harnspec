...
**使用 MCP（推荐）：** 配置 HarnSpec MCP 服务器以获得完整功能。参见 [MCP 集成](/zh-Hans/docs/guide/usage/advanced-features/agent-configuration)。
...
参见 [MCP 集成](/zh-Hans/docs/guide/usage/advanced-features/agent-configuration) 了解完整设置说明。
...
- [MCP 集成](/zh-Hans/docs/guide/usage/advanced-features/agent-configuration) - 模型上下文协议设置
