...
上下文工程是管理 AI 工作记忆 (Working Memory)以最大化效果的实践。HarnSpec 将上下文工程原则应用于Spec管理，确保Spec适应工作记忆并提供高信噪比 (Signal-to-Noise)。
...
**HarnSpec 中的症状**：
```markdown
# Spec包含 20 个集成的 Agent Skills 工具定义
...
**关键见解**：HarnSpec 是用于软件Spec人机协作的上下文工程方法论。
