...
- **Storage**: HarnSpec specs + MCP retrieval
...
1. **MCP Server Integration**: HarnSpec MCP server provides spec search/retrieval
...
AI Agent:
1. Queries HarnSpec MCP: search_specs("database decision")
