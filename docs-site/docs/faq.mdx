...
或从这里复制：[AGENTS.md 模板](https://github.com/harnspec/harnspec/blob/main/AGENTS.md)
...
- **错误：** [GitHub Issues](https://github.com/harnspec/harnspec/issues)
- **功能：** [GitHub Discussions](https://github.com/harnspec/harnspec/discussions)

### 我可以贡献吗？

可以！请参见 [CONTRIBUTING.md](https://github.com/harnspec/harnspec/blob/main/CONTRIBUTING.md)。
...
- **文档：** [完整指南](/docs/guide/)
- **讨论：** [GitHub Discussions](https://github.com/harnspec/harnspec/discussions)
- **问题：** [错误跟踪器](https://github.com/harnspec/harnspec/issues)
...
**更多问题？** 查看[完整文档](/docs/guide/)或在 [GitHub Discussions](https://github.com/harnspec/harnspec/discussions) 中提问。
