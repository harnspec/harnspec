...
**发现：**
- `harnspec list` - 查看所有内容
- `harnspec board` - 可视化工作流
- `harnspec search` - 按关键字查找
- `harnspec list --tags <tag>` - 按类别过滤

**管理：**
- `harnspec deps` - 显示依赖关系
- `harnspec link --depends-on` - 记录阻塞工作
- `harnspec stats` - 项目健康检查
...
**有问题？** 查看 [FAQ](/docs/faq) 或[询问社区](https://github.com/codervisor/harnspec/discussions)。
