...
Want to see these tools in action? Check out the **[HarnSpec project itself](https://web.lean-spec.dev)**—a live example with 100+ specs showing real dependencies, numbering conventions, and project organization.
...
See all these tools in action at **[web.lean-spec.dev](https://web.lean-spec.dev)**—the HarnSpec project's own spec dashboard.
