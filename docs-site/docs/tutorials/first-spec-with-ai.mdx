...
了解 HarnSpec 如何帮助您在几分钟而非几小时内从意图到实现。您将构建一个真实功能——深色主题支持——由 AI 完成繁重工作。
...
- [Spec结构](/docs/guide/usage/spec-structure) - 组织Spec

**需要帮助？** 查看[常见问题](/docs/faq)或[提交问题](https://github.com/codervisor/harnspec/issues)。
