...
2. **HarnSpec 工具包** - CLI/Skills/UI 工具（`harnspec`、Agent Skills 等）
...
**了解更多**：[第一性原理](/docs/advanced/first-principles)
...
| **AI 集成** | AGENTS.md + 脚本 | Agent Skills + CLI |
...
**准备尝试工具包？**
- [快速开始](/docs/guide/getting-started) - 安装 `harnspec`
- [CLI 使用](/docs/guide/usage/cli/overview) - 完整命令参考
- [Agent Skills](/docs/guide/usage/advanced-features/agent-configuration) - 深度 AI 集成

**深入了解方法论：**
- [第一性原理](/docs/advanced/first-principles) - 决策框架
- [上下文工程](/docs/advanced/context-engineering) - 为 AI 优化
- [AI 辅助 Spec 编写](/docs/advanced/ai-assisted-spec-writing) - 高级模式
- [SDD 工作流](/docs/guide/terminology/sdd-workflow) - 完整工作流指南

**有问题？** 查看 [常见问题](/docs/faq) 或 [提交 Issue](https://github.com/codervisor/harnspec/issues)。
