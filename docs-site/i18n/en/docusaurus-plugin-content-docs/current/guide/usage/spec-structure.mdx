...
Understand the anatomy of a HarnSpec spec: frontmatter, required sections, sub-spec files, and how to structure specs for both human and AI understanding.
...
**Important**: These are system-managed. Use `harnspec update` to modify, never edit manually.
...
**Manual editing**: Most fields are managed via CLI. Use `harnspec update` for status/priority/tags, and `harnspec link` for relationships.
