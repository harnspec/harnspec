...
The spec name provided to `harnspec create`.
...
Define your own variables in `.harnspec/config.json`:
...
**Solution:** Check `.harnspec/config.json` has the variable defined.
