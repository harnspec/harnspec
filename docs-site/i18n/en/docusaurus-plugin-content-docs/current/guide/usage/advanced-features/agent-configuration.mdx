...
**With Agent Skills (Recommended):** Use `AGENTS.md` and `SKILL.md` for full functionality. See [Agent Configuration](/docs/guide/usage/advanced-features/agent-configuration).
