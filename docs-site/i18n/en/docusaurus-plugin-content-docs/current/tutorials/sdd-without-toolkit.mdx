...
2. **HarnSpec toolkit** - The CLI/UI tools (`harnspec`, web UI, etc.)
...
| **AI Integration** | AGENTS.md + script | Agent Skills + CLI |
...
- Agent Skills for deep AI integration
...
- [Agent Configuration](/docs/guide/usage/advanced-features/agent-configuration) - Deep AI integration
...
**Questions?** Check [FAQ](/docs/faq) or [file an issue](https://github.com/harnspec/harnspec/issues).
