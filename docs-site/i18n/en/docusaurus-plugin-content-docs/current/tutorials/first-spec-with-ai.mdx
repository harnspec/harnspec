...
Learn how HarnSpec helps you go from intent to implementation in minutes, not hours. You'll build a real feature—dark theme support—with AI doing the heavy lifting.
...
Or run manually:
```bash
harnspec update 015 --status complete
```
