...
From three immutable constraints (physics, biology, economics), five first principles emerge. They define what HarnSpec IS at its core and guide all decisions.
...
HarnSpec is built on three unchangeable constraints:
...
**These constraints are unchangeable.** HarnSpec doesn't fight them—it works within them.
