...
> "HarnSpec is a mindset, not a format."

Beyond the [First Principles](/docs/advanced/first-principles), effective HarnSpec practice requires adopting key mental models and beliefs about how specs should work.
...
## The HarnSpec Mindset

To practice HarnSpec effectively, adopt these core attitudes:
...
The HarnSpec approach is guided by four foundational beliefs:
...
- Refinement and editing (enforce HarnSpec principles)
...
How do you know if you're practicing HarnSpec effectively?
...
If your specs help people (and AI agents) build better software faster, you're doing HarnSpec right.

---

**Next**: Explore practical day-to-day techniques in [AI-Assisted Spec Writing](/docs/advanced/ai-assisted-spec-writing), or learn [When to Write Specs](/docs/guide/understanding-harnspec#when-to-write-a-spec) in HarnSpec.
