...
1. Run `harnspec init` to create the `AGENTS.md` and `SKILL.md` (via `harnspec skill install`).
2. These files provide the necessary instructions for AI agents to use the `harnspec` CLI.
3. Most modern AI agents (like Claude Code) can discover and use CLI tools automatically if they are told about them.
...
Or copy from: [AGENTS.md template](https://github.com/harnspec/harnspec/blob/main/AGENTS.md)
...
- **Claude Code**: Auto-loads AGENTS.md via Agent Skills
...
- `.cursorrules`
- System prompts in Agent Skills config
...
- **Bugs:** [GitHub Issues](https://github.com/harnspec/harnspec/issues)
- **Features:** [GitHub Discussions](https://github.com/harnspec/harnspec/discussions)

### Can I contribute?

Yes! See [CONTRIBUTING.md](https://github.com/harnspec/harnspec/blob/main/CONTRIBUTING.md).
...
- **Discussions:** [GitHub Discussions](https://github.com/harnspec/harnspec/discussions)
- **Issues:** [Bug tracker](https://github.com/harnspec/harnspec/issues)
...
**More questions?** Check the [full documentation](/docs/guide/) or ask in [GitHub Discussions](https://github.com/harnspec/harnspec/discussions).
