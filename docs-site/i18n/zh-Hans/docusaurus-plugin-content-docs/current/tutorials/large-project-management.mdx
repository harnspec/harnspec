...
想要看到这些工具的实际应用？查看 **[HarnSpec 项目本身](https://web.lean-spec.dev)**——一个包含 100 多个Spec的实时示例，展示了真实的依赖关系、编号约定和项目组织。
...
在 **[web.lean-spec.dev](https://web.lean-spec.dev)** 查看所有这些工具的实际应用——HarnSpec 项目自己的Spec仪表板。
